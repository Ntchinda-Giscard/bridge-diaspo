...
export const SIGNUP_MUTATION = gql`mutation InsertUser($nom: String = "", $prenom: String = "", $telephone: bpchar = "", $sexe: bpchar = "", $email: String = "", $mot_passe: String = "", $country: String = "", $date_naisse: bpchar = "") {
